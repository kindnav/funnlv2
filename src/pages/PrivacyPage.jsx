      ...
      <div className="w-full max-w-[680px]">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-[10px] bg-[linear-gradient(135deg,#8B7CFF,#5B45F0)] flex items-center justify-center flex-none">
        ...
        <Section title="Third parties we share data with">
          ...
          <div className="space-y-5 mt-1">
            ...
            <div className="pl-4 border-l-2 border-[rgba(255,255,255,0.08)]">
              <p className="font-semibold text-hi mb-1">PostHog — product analytics</p>
              <p>Funnl uses PostHog to understand how people use the product (for example, whether they add contacts, log interactions, or use certain features). PostHog receives <strong className="text-hi font-semibold">usage behavior only</strong> — things like "a user logged an interaction." It never receives the content of your contacts — not names, companies, notes, emails, or anything you've typed. <a href="https://posthog.com/privacy" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-tag no-underline">PostHog privacy policy →</a></p>
            </div>
