      ...
      <div className="w-full max-w-[680px]">
        ...
        <Section title="Gmail connection (optional)">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li><strong className="text-hi font-semibold">Disconnecting Gmail</strong> — disconnecting Gmail from Settings stops Funnl using your Gmail access immediately, turns off the Gmail connection, deletes Funnl's Gmail synchronization state and history cursor, and removes every Gmail suggestion you have not acted on together with its subject line. Interactions you already accepted stay, and Google Calendar is not affected.</li>
