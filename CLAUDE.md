...
- `src/lib/subscriptionStatusPolicy.js` — NEW (R2). Canonical shared status policy (checkoutMode/grantsAccess/uiState) imported by the checkout backend AND the UI. `tests/subscription-status-policy.test.js`.
